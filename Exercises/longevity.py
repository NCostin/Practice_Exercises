...
class Application(Frame):
	...
	def reveal(self):
		...
		contents = self.pw_ent.get() # get() method returns the text in the widget
		...
		self.secret_txt.delete(0.0, END) #deletes any text already in the Text widget

		self.secret_txt.insert(0.0, message) #insert method can insert a string into a text-based widget
