...
def ask_store_score(score):
	ask_score = input("Do you want to store you score? yes/no ")

	if ask_score.lower() == "yes":

		player_name = input("Please type your name: ")
		list_ = [player_name," ", str(score),"\n"]

		f = open("pickles_enchanted_trivia.txt", "a")
	...
	f = open("pickles_enchanted_trivia.txt", "r")
...
def main():
    trivia_file = open_file("trivia-enchanted.txt", "r")
